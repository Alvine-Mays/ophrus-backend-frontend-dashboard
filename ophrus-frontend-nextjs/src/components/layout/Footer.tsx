        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2">
              <li>
                <Link href="/home" className="text-gray-400 hover:text-blue-primary transition-colors text-sm">
                  Accueil
                </Link>
              </li>
              <li>
                <Link href="/properties" className="text-gray-400 hover:text-blue-primary transition-colors text-sm">
                  Propriétés
                </Link>
              </li>
              <li>
                <Link href="/about" className="text-gray-400 hover:text-blue-primary transition-colors text-sm">
                  À propos
                </Link>
              </li>
              <li>
                <Link href="/contact" className="text-gray-400 hover:text-blue-primary transition-colors text-sm">
                  Contact
                </Link>
              </li>
              <li>
                <Link href="/login" className="text-gray-400 hover:text-blue-primary transition-colors text-sm">
                  Connexion
                </Link>
              </li>
            </ul>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center space-x-3">
                ...
                <span className="text-gray-400 text-sm">contact@ophrus-immobilier.cg</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="border-t border-gray-800 mt-12 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            ...
            <div className="flex space-x-6">
              <Link href="/privacy" className="text-gray-400 hover:text-blue-primary transition-colors text-sm">
                Politique de confidentialité
              </Link>
              <Link href="/terms" className="text-gray-400 hover:text-blue-primary transition-colors text-sm">
                Conditions d'utilisation
              </Link>
              <Link href="/cookies" className="text-gray-400 hover:text-blue-primary transition-colors text-sm">
                Cookies
              </Link>
            </div>
          </div>
